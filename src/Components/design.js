    ...
    return(
        <div className="card  shadow h-100 py-2" id="design">
            <div className="card-body">
                ...
                <div className="col-6">
                    <img src={versionesStyles} class="rounded mx-auto d-block" alt="versionesStyles"/>               
                </div>
                </div>
                <div className="row no-gutters align-items-center">
                <h5 className="text font-weight-bold text-primary mb-1">Manejo de Colores</h5>
                <br></br>
                <h6 align="justify" >Se identificó que las dos paletas cuentan con colores muy parecidos y para lograr 
                    ...
                    Este problema se soluciona en gran medida utilizando el tema oscuro ya que solo tuvo un problema de contraste.</h6>
                </div>
                <div className="row no-gutters align-items-center">
                <div className="col-5">
                    ...
                    <div className="card py-2">
                        <div className="card-body">
                            <img src={lightPalette} class="img-fluid" alt="versionesStyles"/>               
                        </div>
                    </div>
                    <br></br>
                    <div className="card py-2">
                        <div className="card-body">
                            <img src={bottonNBLight} class="img-fluid" alt="versionesStyles"/>
                            <br></br>
                            <br></br>
                    ...
                    <div className="card py-2">
                        <div className="card-body">
                            <img src={appBarLight} class="img-fluid" alt="versionesStyles"/> 
                            <br></br>
                            <br></br>
                            <h6>Contrast ratio item actual: 2.57</h6>
                            <h6>Contrast ratio item inactivo: 6.19</h6>
                    ...
                    <div className="card py-2">
                        <div className="card-body">
                            <img src={carpetasLight} class="img-fluid" alt="versionesStyles"/>  
                            <br></br>
                            <br></br>   
                    ...
                    <div className="card py-2">
                        <div className="card-body">
                            <img src={botonLight} class="img-fluid" alt="versionesStyles"/>
                            <br></br>
                            <br></br>
                ...
                <br></br>
                    ...
                    <div className="card py-2">
                        <div className="card-body">
                            <img src={darkPalette} class="img-fluid" alt="versionesStyles"/>               
                        </div>
                    </div>
                    <br></br>
                    <div className="card py-2">
                        <div className="card-body">
                            <img src={bottonNBDark} class="img-fluid" alt="versionesStyles"/>
                            <br></br>
                            <br></br> 
                    ...
                    <div className="card py-2">
                        <div className="card-body">
                            <img src={appBarDark} class="img-fluid" alt="versionesStyles"/>
                            <br></br>
                            <br></br> 
                    ...
                    <div className="card py-2">
                        <div className="card-body">
                            <img src={carpetasDark} class="img-fluid" alt="versionesStyles"/>    
                            <br></br>
                            <br></br> 
                    ...
                    <div className="card py-2">
                        <div className="card-body">
                            <img src={botonDark} class="img-fluid" alt="versionesStyles"/>   
                            <br></br>
                            <br></br>     
                ...
                <div className="row no-gutters align-items-center">
                    ...
                    <img src={img1} class="img-fluid" alt="versionesStyles"/>   
                    </div>
                    <div className="col-10">
                    <img src={img2} class="img-fluid" alt="versionesStyles"/>   
                    </div>
                    </div>
                    </div>
